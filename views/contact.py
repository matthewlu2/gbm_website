...
st.markdown("<h3 style='text-align: center; color: black; font-size:25px;'>The Department of Biomedical Informatics (DBMI)<br> at the University of Pittsburgh School of Medicine</h3>", unsafe_allow_html=True)
