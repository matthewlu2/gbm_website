...
a.markdown("""<span style="font-size:25px;">The Department of Biomedical Informatics (DBMI) at the University of Pittsburgh School of Medicine, 5607 Baum Blvd, Suite 500</span>""", unsafe_allow_html=True)
...
a.markdown("""<span style="font-size:18px;">Xiaojun Ma<br>Software Engineer<br>✉️ xim33@pitt.edu</span>""", unsafe_allow_html=True)
